 ...
 */
export function getCSSComponentsForPlugin(
	options: PreparsedIconifyPluginOptions
) {
 ...
 */
export function getCSSRulesForPlugin(options: PreparsedIconifyPluginOptions) {
	const rules = Object.create(null) as Record<string, Record<string, string>>;
